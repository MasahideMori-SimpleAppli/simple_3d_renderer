...
class Sp3dLight {
  ...
  Sp3dLight(this.direction, {this.minBrightness=0.0, this.applyStroke = false, this.syncCam = true});
  ...
  ///
  Sp3dLight deepCopy(){
    return Sp3dLight(this.direction, minBrightness: this.minBrightness, applyStroke: this.applyStroke, syncCam: this.syncCam);
  }
